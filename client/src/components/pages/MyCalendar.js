...
const defaultEvents = [{
  ...
  id: 2,
  start: '2022-12-25T15:00',
  end: '2022-12-25T16:00',
...
function MyCalendar() {
  ...
  // popup options
  const headerText = React.useMemo(() => isEdit ? 'Edit Workout' : 'New Workout', [isEdit]);
  ...
  return <div>
      ...
      >
          <div className="mbsc-form-group">
              <Input label="Exercise" value={popupEventTitle} onChange={titleChange} />
